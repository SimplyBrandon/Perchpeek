...
class TicketAPIController extends Controller
{
    ...
    public function getTicketStatistics()
    {
        $statistics = [
            ...
            'most_frequent_creator' => DB::table('tickets')->selectRaw('creator_name, creator_email, COUNT(*) as tickets')->groupBy('creator_email')->orderBy('tickets', 'desc')->first()->creator_name,
