...
class TicketAPIController extends Controller
{
    ...
    public function getTicketStatistics()
    {
        $statistics = [
            ...
            'most_frequent_creator' => DB::table('tickets')->selectRaw('creator_email, creator_name, COUNT(*) as tickets, creator_name')->groupBy('creator_email')->orderBy('tickets', 'desc')->first(),
