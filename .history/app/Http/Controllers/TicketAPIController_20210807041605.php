...
class TicketAPIController extends Controller
{
    ...
    public function getTicketStatistics()
    {
        $statistics = [
            ...
            'most_frequent_creator' => DB::table('tickets')->selectRaw('creator_email as email, creator_name as name, COUNT(*) as tickets')->groupBy('email')->orderBy('tickets', 'desc')->first(),
